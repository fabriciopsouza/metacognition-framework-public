...
**Comece:** [Instalar no VS Code](guia/INSTALAR-NO-VSCODE.md) · [Site](https://fabriciopsouza.github.io/metacognition-framework-public/) · [Releases](https://github.com/fabriciopsouza/metacognition-framework-public/releases) · [Segurança](SECURITY.md) · [Telemetria (opt-out)](TELEMETRY.md) · [Como foi construído](guia/COMO-FOI-CONSTRUIDO.md)
...
> **Versão:** 1.39.0 · **Autor:** Fabricio Souza (github.com/fabriciopsouza/metacognition-framework-public) · **Base:** pesquisas A0–A3 · **PT-BR** · **CC BY 4.0** (ver [`LICENSE`](LICENSE) · [`NOTICE`](NOTICE))
...
- **Prompt do chat web:** `PROMPT-CHAT-WEB-v4.3.md` (raiz) — encarnação do framework para
