...
> **Versão:** 1.77.0 · **Autor:** Fabricio Souza (github.com/fabriciopsouza/metacognition-framework-public) · **Base:** pesquisas A0–A3 · **PT-BR** · **CC BY 4.0** (ver [`LICENSE`](LICENSE) · [`NOTICE`](NOTICE))
...
- **Prompt do chat web:** `PROMPT-CHAT-WEB-v4.5.md` (raiz) — encarnação do framework para
