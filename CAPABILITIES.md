...
> **47 capacidades** — 43 ✅ PROVIDES · 4 🟡 PARTIAL · 🔗 = cross-IA. Fonte: [capabilities.json](capabilities.json). Canario anti-drift: [test_capabilities.py](tools/test_capabilities.py) (ADR-072).
...
- ✅ `context-budget-gate` — context-budget: decide LER-INTEIRO vs FRACIONAR (doc-intake) p/ fontes grandes (anti-queima de tokens)
