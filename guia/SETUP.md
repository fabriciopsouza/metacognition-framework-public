...
Espelha as skills para `~/.claude/`, ativa o perfil sem hooks e cria seu cofre local. Rodar duas
vezes não quebra nada. Em máquina onde o PowerShell roda liberado, `bootstrap.ps1` ativa também os
hooks automáticos.
