...
Onde o EDR veta PS (hook não roda — ADR-060/061): as dims fail-closed já rodam via
`python tools/test_consistency_closing.py` (suíte/CI); as demais (unpushed, transientes), checar manualmente.
