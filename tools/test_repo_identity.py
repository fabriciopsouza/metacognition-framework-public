...
def main():
    fails = []
    SSH = "git@github.com:fabriciopsouza/metacognition-framework-public.git"
    HTTPS = "https://github.com/fabriciopsouza/metacognition-framework-public"
    ...
    if _norm_remote(SSH) != "github.com/fabriciopsouza/metacognition-framework-public":
