...
> Alinhado ao Framework Metacognitivo v1.80.1 (roteador v2.3). Substitui o v4.4.
...
Antes de escrever fórmula/cálculo/código que computa ou depende de um **indicador, métrica ou regra de domínio de risco alto** (regulado · número que vai a decisão · do setor regulado/saúde/financeiro), **elicitar e confirmar PROACTIVAMENTE** — mesmo em postura autosuficiente; **não inferir e corrigir reativo** ("perto, mas errado" em indicador regulado é falha):
...
---
*v4.5 — chat web, tier público autocontido. Alinhado ao Framework Metacognitivo v1.80.1 (roteador v2.3).*
